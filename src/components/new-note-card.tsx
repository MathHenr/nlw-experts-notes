    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-y-1/2 md:-translate-x-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col" >
                    ...
                    <form className="flex flex-col flex-1">
                        ...
                        { isRecording ? (
                            <button
                            type="button"
                            className="w-full flex items-center justify-center gap-3 bg-slate-900 py-4 text-center text-slate-300 text-sm hover:text-slate-100"
                            ...
                            <button
                                type="button"
                                className="w-full bg-lime-400 py-4 text-center text-slate-950 text-sm hover:bg-lime-500"
